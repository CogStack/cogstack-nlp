script_path="scripts/performance/get_entity_throughput.py"
data_path="/Users/martratas/Documents/CogStack/MedCAT/MedCATv2_new/.temp/2025_03_24_training_speed/unsup_data/mimic_iv_discharge_head20.csv"
...
python $script_path $v1_model_pack $data_path suppress
...
python $script_path $v2_model_pack $data_path suppress
